            ...
            <section className="py-24 bg-[#0f172a] border-b border-white/5 relative overflow-hidden">
                ...
                <div className="container px-4 mx-auto text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white tracking-tight">
                        Premium <span className="text-primary italic">Books</span> for Growth
                    </h1>
                    <p className="text-slate-300 text-lg max-w-2xl mx-auto leading-relaxed">
                        Thought-provoking insights and systematic frameworks, delivered right to your screen. 
                        No downloads, just pure knowledge.
                    </p>
                </div>
            </section>
